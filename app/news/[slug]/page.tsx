  ...
  return (
    <div className="min-h-screen bg-slate-50 pt-24">
      ...
      <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 py-10">
          ...
          <div className="p-8 sm:p-12">
            ...
            <div className="prose prose-slate max-w-none">
              ...
              <p className="text-slate-600 leading-relaxed mb-4">
                EVA Nepal continues to work diligently to represent the interests
                of event venues across Kathmandu Valley. The association invites
                all venue owners and event industry professionals to join and be
        ...
        {related.length > 0 && (
          <div className="mt-10">
            <h2 className="font-serif font-bold text-navy-900 text-xl mb-6">
              Related News
            </h2>
            <div className="grid sm:grid-cols-3 gap-5">
              {related.map((n) => (
                <Link
                  key={n.id}
                  href={`/news/${n.slug}`}
                  className="bg-white rounded-xl border border-slate-100 p-5 hover:border-gold-200 hover:shadow-card transition-all group"
                >
                  <span className="text-xs text-gold-600 font-medium capitalize">
                    {n.category}
                  </span>
                  <h3 className="font-serif font-bold text-navy-900 text-sm mt-2 mb-2 leading-snug group-hover:text-navy-700 line-clamp-3">
                    {n.title}
                  </h3>
